...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, animations_1.BrowserAnimationsModule, http_2.HttpClientModule, __spreadArrays(kendoui_module_1.PrimengModule), __spreadArrays(kendoui_module_1.KendouiModule), kendo_angular_intl_1.IntlModule, forms_1.FormsModule, http_1.HttpModule, forms_1.ReactiveFormsModule, app_routing_1.routing],
            declarations: [app_component_1.AppComponent, keep_html_pipe_1.EscapeHtmlPipe, ng2_summernote1_1.Ng2Summernote1, __spreadArrays(app_routing_1.routedComponents), PassCpintroComponent_1.PassCpIntroComponent, ErrorComponent_1.ErrorComponent],
            providers: [appset_1.AppSet, AuthGuard_1.AuthGuard, common_1.DatePipe, __spreadArrays(app_service_1.appService), { provide: core_1.LOCALE_ID, useValue: "zh" }, primeng_1.ConfirmationService, messageservice_1.MessageService],
