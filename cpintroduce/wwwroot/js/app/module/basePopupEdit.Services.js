...
var basePopupEditServices = /** @class */ (function (_super) {
    __extends(basePopupEditServices, _super);
    function basePopupEditServices(http, appset, confirmservice) {
    ...
    basePopupEditServices.prototype.setOldItem = function (item) {
        this.oldItem = item;
    };
    basePopupEditServices.prototype.read = function () {
        var _this = this;
    ...
    basePopupEditServices.prototype.fetch = function (querystr) {
    ...
    basePopupEditServices.prototype.doQuery = function (querystring) {
        var _this = this;
    ...
    basePopupEditServices.prototype.savedata = function (action, data) {
        if (action === void 0) { action = ""; }
        var headers = new http_1.HttpHeaders().set('Content-Type', 'application/json');
        return this.http.post(this.appset.api_url + this.saveurl + "/" + action, data, { headers: headers });
    };
    basePopupEditServices.prototype.save = function (data, isNew) {
        var _this = this;
        this.busya.next(["busy"]);
        ...
        this.savedata(action, data)
            ...
            if (isNew) {
                var tempdata = __spreadArrays(_this.data);
                _this.data = [];
                tempdata.splice(0, 0, sdata);
                _this.data = __spreadArrays(tempdata);
    ...
    basePopupEditServices.prototype.remove = function (data) {
        var _this = this;
    ...
    basePopupEditServices.prototype.removedata = function (data) {
        ...
        var tempdata = __spreadArrays(this.data);
        this.data = [];
        tempdata.splice(index, 1);
        this.data = __spreadArrays(tempdata);
        _super.prototype.next.call(this, this.data);
        return this.savedata(REMOVE_ACTION, data);
    };
    basePopupEditServices.prototype.resetItem = function (dataItem) {
        //if (!dataItem) { return; }
        ////find orignal data item
        //const originalDataItem = this.data.find(item => item.ProductID === dataItem.ProductID);
    };
    basePopupEditServices.prototype.reset = function () {
        this.data = [];
    };
    basePopupEditServices.prototype.getData = function () {
        return this.data;
    };
    Object.defineProperty(basePopupEditServices.prototype, "saveUrl", {
        set: function (url) {
            this.saveurl = url;
        },
        enumerable: true,
...
exports.basePopupEditServices = basePopupEditServices;
//# sourceMappingURL=basePopupEdit.Services.js.map